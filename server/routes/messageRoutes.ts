...
import { deleteConversation, getConversations, getMessages, sendMessage, startOrGetConversation } from "../controllers/messageController.js";
...
messageRouter.get("/conversations/with/:targetUserId", startOrGetConversation);

...
const STORY_DURATION = 5000; // seconds
      ...
      <View style={styles.container}>
        ...
        <View style={styles.progressRow}>
            {userStory.stories.map((_, index) => (
                <View key={index} style={styles.progressTrack}>
                    <Animated.View style={[styles.progressFill, index < currentIndex ? {width: "100%"} : index === currentIndex ? {width: progressAnim.interpolate({
                        inputRange: [0, 1],
                        outputRange: ["0%", "100%"]
                    })} : {width: "0%" }]} />
                </View>
        ...
        <View style={styles.header}>
            <View style={styles.userRow}>
                <Avatar name={userStory.user.name} size={38} src={userStory.user.avatar} />
                <View>

...
export default function ConvoItem({convo, selected, onPress} : ConvoItemProps) {
    ...
    const lastMessage = convo.lastMessage?.text || (convo.lastMessage?.mediaType === "image" ? "📷 Sent an Image" : convo.lastMessage?.mediaType === "video" ? "🎥Sent a Video" : "Start a Conversation");
  return (
